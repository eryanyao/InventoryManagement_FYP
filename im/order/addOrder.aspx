        ...
        <div class="w3-container">
            ...
            <p>
                ...
                <p>
                    ...
                    <asp:TextBox ID="txtName" CssClass="w3-input w3-border" Enabled="false" runat="server" placeholder="Enter customer name" />
                ...
                <p>
                    ...
                    <asp:TextBox ID="txtPhone" TextMode="Phone" CssClass="w3-input w3-border" Enabled="false" runat="server" placeholder="Enter customer phone" />
                ...
                <p>
                    ...
                    <asp:TextBox ID="txtAddress" CssClass="w3-input w3-border" Enabled="false" runat="server" placeholder="Enter customer address" />
