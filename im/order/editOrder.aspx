<%@ Page Title="" Language="C#" MasterPageFile="~/im/MasterPage.master" AutoEventWireup="true"
    CodeFile="editOrder.aspx.cs" Inherits="im_order_addOrder2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="divForm" class="w3-row-padding w3-margin-bottom w3-light-grey w3-border"
        ...
        <div class="w3-container">
            <h2 class="w3-text-black"><strong>Edit order</strong></h2>
            <p>
                <table class="w3-right">
                     <tr>
                        <td class="w3-text-black w3-margin-right" style="width: 120px;"><b>Invoice #:</b></td>
                        <td>
                            <asp:Label ID="lblBillId" Text="" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="w3-text-black w3-margin-right" style="width: 120px;"><b>Date:</b></td>
                        <td>
            ...
            <p>
                ...
                <p>
                    ...
                    <asp:TextBox ID="txtName" CssClass="w3-input w3-border" runat="server" placeholder="Enter customer name" />
                ...
                <p>
                    ...
                    <asp:TextBox ID="txtPhone" TextMode="Phone" CssClass="w3-input w3-border" runat="server" placeholder="Enter customer phone" />
                ...
                <p>
                    ...
                    <asp:TextBox ID="txtAddress" CssClass="w3-input w3-border" runat="server" placeholder="Enter customer address" />
                ...
                <div class="w3-white w3-padding">
                    ...
                    <br />
                    <asp:Button ID="btnAddProduct" CssClass="w3-button w3-green" Text="Add Product" runat="server" OnClick="btnAddProduct_Click" />
                </div>
                <br />
