<%@ Page Title="" Language="C#" MasterPageFile="~/im/MasterPage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="im_category_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <header class="w3-container" style="padding-top: 22px">
        <h3><b><i class="fa fa-cubes"></i>&nbsp;Category</b> <small style="font-size: x-small;">
            Manage</small></h3>
    </header>

    <div class="w3-container">
        <asp:Button Text="Add Category" runat="server" ID="btnAdd" CssClass="w3-button w3-border w3-green"
    ...
    <div id="divForm" class="w3-row-padding w3-margin-bottom w3-light-grey w3-border"
        ...
        <div class="w3-container">
            ...
            <h2 class="w3-text-black"><strong>
                <asp:Label ID="lblHeader" Text="Add new category" runat="server" /></strong>
            </h2>
            <p>
                <label class="w3-text-black"><b>Category Name</b></label>
                <asp:TextBox ID="txtCategory" CssClass="w3-input w3-border" runat="server" placeholder="Enter category name" />
                <asp:RequiredFieldValidator ErrorMessage="Field Required!" Display="Dynamic" CssClass="w3-text-red"
                    ControlToValidate="txtCategory" runat="server" ValidationGroup="1" />
    ...
    <asp:SqlDataSource ID="brandSQL" runat="server" ConnectionString="<%$ ConnectionStrings:connStr %>"
        SelectCommand="SELECT Id,category_name,category_status FROM category" UpdateCommand="UPDATE category SET category_name = @category_name, category_status=@category_status WHERE Id = @Id"
        ...
        <UpdateParameters>
            <asp:Parameter Name="category_name" />
            <asp:Parameter Name="category_status" />
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="width: 200px">
                                    <asp:Label Text='<%# show(Eval("category_status").ToString())%>' CssClass='<%# color(Eval("category_status").ToString())%>'
                                        runat="server" />
                                </td>
                                <td>
